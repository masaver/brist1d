...
from src.features.transformers import DropColumnsTransformer, ExtractColumnsTransformer, FillPropertyNaNsTransformer, GetDummiesTransformer, \
    PropertyOutlierTransformer, Log1pTransformer, StandardScalerTransformer, DateTimeTransformer, DateTimeHourTransformer
...
preprocessing_pipeline = Pipeline(steps=[
    ('date_time', DateTimeHourTransformer(time_column='time', result_column='hour', type='bins', number_of_bins=12)),
