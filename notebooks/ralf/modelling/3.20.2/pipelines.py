...
from src.features.transformers import DropColumnsTransformer, ExtractColumnsTransformer, FillPropertyNaNsTransformer, GetDummiesTransformer, \
    PropertyOutlierTransformer, Log1pTransformer, StandardScalerTransformer, DateTimeTransformer
...
standardization_pipeline = Pipeline(steps=[
    ...
    ('log_transformer', Log1pTransformer(columns=columns_to_extract[2:40])),
